                            ...
                            <header>
                                ...
                                <h3 class="text-2xl lg:text-3xl font-bold leading-tight mb-2">
                                    <a class="hover:text-gray-100 transition duration-150 ease-in-out"
                                        href="#0">Proyecto para en el ensayo de diferentes dependencias que podrian ser implementados en los futuros proyectos.</a>
                                </h3>
                            </header>
                            <p class="text-lg text-gray-400 flex-grow">
                                Una descripcion para el proyecto, CAJAARENA es basicamente un proyecto sin animo de lucro, solo es para instalar dependencias nuevas 
                            </p>
                            <footer class="flex items-center mt-4">
                                <a href="#0">
                                    <img class="rounded-full flex-shrink-0 mr-4"
                                        src="https://www.dropbox.com/s/owomqq75uamsu18/BLANCO%20actual%20foto%20perfil.jpg?dl=0"
